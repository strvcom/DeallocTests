...
instead send your report privately to <daniel.cech@strv.com>.
...
See [CODE_OF_CONDUCT.md](https://github.com/DanielCech/DeallocTests/blob/master/CODE_OF_CONDUCT.md) for details.

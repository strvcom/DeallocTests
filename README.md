...
[![License](https://img.shields.io/cocoapods/l/DeallocTests.svg)](https://raw.githubusercontent.com/DanielCech, jankaltoun/DeallocTests/master/LICENSE)
...
[![Travis](https://img.shields.io/travis/DanielCech, jankaltoun/DeallocTests/master.svg)](https://travis-ci.org/DanielCech, jankaltoun/DeallocTests/branches)
[![SwiftFrameworkTemplate](https://img.shields.io/badge/SwiftFramework-Template-red.svg)](http://github.com/RahulKatariya/SwiftFrameworkTemplate)

Easy to use library for implementation of custom deallocation tests
...
```ogdl
github "DanielCech, jankaltoun/DeallocTests" ~> 0.0.1
```
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/DanielCech, jankaltoun/DeallocTests.git", .upToNextMajor(from: "0.0.1"))
    ],
    targets: [
...
```bash
$ git submodule add https://github.com/DanielCech, jankaltoun/DeallocTests.git
...
- Download the latest release from https://github.com/DanielCech, jankaltoun/DeallocTests/releases
- Next, select your application project in the Project Navigator (blue project icon) to navigate to the target configuration window and select the application target under the "Targets" heading in the sidebar.
- In the tab bar at the top of that window, open the "General" panel.
- Click on the `+` button under the "Embedded Binaries" section.
...
Daniel Cech, Jan Kaltoun [@DanielCech, jankaltoun](https://twitter.com/DanielCech, jankaltoun)

## License

DeallocTests is released under the MIT license. See [LICENSE](https://github.com/DanielCech, jankaltoun/DeallocTests/blob/master/LICENSE) for details.
